...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/bandido1.png", __ASSET__assets_images_bandido1_png);
		type.set ("assets/images/bandido1.png", AssetType.IMAGE);
		className.set ("assets/images/espada.png", __ASSET__assets_images_espada_png);
		type.set ("assets/images/espada.png", AssetType.IMAGE);
		className.set ("assets/images/images-go-here.txt", __ASSET__assets_images_images_go_here_txt);
		type.set ("assets/images/images-go-here.txt", AssetType.TEXT);
		className.set ("assets/images/tilesPiso.png", __ASSET__assets_images_tilespiso_png);
		type.set ("assets/images/tilesPiso.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/tilesPiso.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_testlevel_oep extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_images_bandido1_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_espada_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_images_go_here_txt extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_images_tilespiso_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/testlevel.oep") #if display private #end class __ASSET__assets_data_testlevel_oep extends lime.utils.Bytes {}
@:image("assets/images/bandido1.png") #if display private #end class __ASSET__assets_images_bandido1_png extends lime.graphics.Image {}
@:image("assets/images/espada.png") #if display private #end class __ASSET__assets_images_espada_png extends lime.graphics.Image {}
@:file("assets/images/images-go-here.txt") #if display private #end class __ASSET__assets_images_images_go_here_txt extends lime.utils.Bytes {}
@:image("assets/images/tilesPiso.png") #if display private #end class __ASSET__assets_images_tilespiso_png extends lime.graphics.Image {}
